...
# #len(przejazdy_sklad_czesci)
# for id_przejazdy_sklad_czesci in range(1, 20):
#
...
#         for miejsce in range(1,1+int(wagony[id_wagonu].split(',')[2])):
#             driver[id_przejazdu][miniPrzejazd][nr_wagonu][miejsce] = 0
#
...
for i in range(1, len(bilety_jednorazowe_zamowienia)):
    ...
    file.write(f"{i},{i},{1},{5},{1},{1},{random.randint(0, 7)}\n")
    # for miniPrzejazd in range(start, end):
