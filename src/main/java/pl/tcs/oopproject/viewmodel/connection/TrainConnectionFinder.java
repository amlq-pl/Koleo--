...
public class TrainConnectionFinder implements FindTrainConnection {
    ...
    private TrainConnectionFinder(String stationA, String stationB, LocalDateTime departureDate) {
    ...
    @Override
    public List<MultiStopRoute> findTrainRoutes() throws SQLException {
        if (!active) setTrains();
    ...
    @Override
    public List<MultiStopRoute> getDirectTrainRoutes() throws SQLException {
        if (!active) setTrains();
